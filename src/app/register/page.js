...
const register = () => {
    ...
    <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <div className="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
         <Image className="mr-2" src={"https://flowbite.s3.amazonaws.com/blocks/marketing-ui/logo.svg"} width={10} height={10} alt="logo"/>
         <span>
             Wide    
         </span>
        </div>
        <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <div>
                    ...
                    <div>
                        <label htmlFor="password" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Bio</label>
                    ...
                    <div className="">
                        ...
                        <input className="" onClick={handlePic} type="file" name="avatar" id="avatar"  />
                    ...
                    <button className="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" onClick={sendForm}>Sign up</button>                
                    </form>

                    <div>
                    <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                    Already signup? <Link href={'/Login'} className="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign in</Link></p>
                    </div>
            </div>
        </div>
    </div>
