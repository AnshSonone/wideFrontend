...
export default function Post({ id, username, avatar, created, videoDescription, videoUrl, tag, userId }) {
  ...
  return (
    <div className=" bg-gray-200 py-2 rounded-md shadow-xl my-4 space-y-2" >
      {/* {
      ...
      {
        user?.id == userId && <div className="space-x-2 mx-2">
        <button className=" hover:bg-gray-300 p-2 border-[1px] border-black rounded-md text-sm" onClick={deletePost}>
          <RiDeleteBin5Line />
        </button>
      </div>
      }
